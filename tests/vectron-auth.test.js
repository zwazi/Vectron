...
assert.match(firestoreRules, /submission\(data\.resubmissionOf\)\.data\.status == 'denied'/);
assert.match(firestoreRules, /submission\(data\.resubmissionOf\)\.data\.submittedBy == request\.auth\.uid/);
