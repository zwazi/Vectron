...
assert.match(authSource, /submission\.operation === "server-review"\s*\? await nextAvailableReviewVersion/);
assert.match(authSource, /function nextAvailableReviewVersion[\s\S]*let version = normalizeMapVersion\(startingVersion\)/);
assert.doesNotMatch(authSource, /submission\.operation === "server-review"\s*&&\s*!submission\.reviewRevisionId/);
