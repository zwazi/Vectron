...
assert.match(authSource, /const finalCategory = MAP_CATEGORY;/);
...
assert.match(firestoreRules, /request\.resource\.data\.category == 'maps'/);
assert.match(firestoreRules, /\[\^\/\]\+\\\\\.aamap\\\\\.xml/);
...
assert.match(firestoreRules, /&& \(isAdmin\(\) \|\| \(hasApprovedAccount\(\)/);
