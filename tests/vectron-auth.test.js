...
assert.match(index, /id="map-repository-others-tab"[^>]*>Race maps /);
...
assert.match(index, /id="tooltip-welcome-disable"[^>]*>Disable tooltips<\/button>/);
...
assert.match(index, /href="\.\/css\/workspace-theme\.css"/);
...
assert.match(workspaceCss, /--workspace-cyan:\s*#55f4dc/);
