...
assert.match(index, /id="show-previous-point-guidelines"/);
assert.match(index, /id="show-current-point-guidelines"/);
...
assert.match(wallToolSource, /function wallTool_axisGuideStyle\(/);
assert.match(configSource, /WALL_AXIS_GUIDE_DEFAULT_COLOR = '#22c55e'/);
assert.match(configSource, /label: 'Wall alignment guides'/);
assert.match(configSource, /case "showAxisAlignmentGuides": return "true"/);
assert.match(configSource, /case "showPreviousPointGuidelines": return "true"/);
assert.match(configSource, /case "showCurrentPointGuidelines": return "true"/);
