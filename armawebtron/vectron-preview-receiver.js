/* First-party Vectron receiver for the self-hosted Armawebtron preview. */
...
(function() {
    ...
    window.addEventListener("message", function(event) {
        var data = event.data;
        if(event.origin !== window.location.origin || !data || data.type != MESSAGE_TYPE ||
           data.source != "Vectron" || typeof data.xml != "string") {
            return;
        }
